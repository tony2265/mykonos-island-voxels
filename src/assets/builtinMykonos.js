 ...
 * builtinMykonos.js
 *
 * The bundled "flower" style pack. This is the original asset set, kept
 * in-code (with procedural voxel builders as a fallback) so the editor
 * works even before any external style packs are shipped.
 *
 * External style packs (Codex-generated) live under /assets/<id>/ and are
 * loaded from manifest.json by styleRegistry.js — they do NOT need builders.
 */
...
export const BUILTIN_STYLE = Object.freeze({
    id: 'flower',
    name: 'Flower',
    assets: ASSETS,
});
